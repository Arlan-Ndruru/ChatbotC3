...
class helpDeskC3 extends Conversation
{
    /**
     * First question
     */
    ...
    {
        $question = Question::create('Komfirmasi untuk Mengajukan Permasalahan ke C3?')
		->addButtons([
        ...
        $this->ask($question, function (Answer $answer) {
            if($answer->getValue() === 'yes'){
                $this->say('Anda memilih : <b>Mengajukan permasalahan</b>',['parse_mode' => 'HTML']);
                $this->sendMessage();
            }
            elseif ($answer->getValue() === 'netral') {
                $this->say('Anda memilih : <b>Melihat Format Pesan untuk mengajukan permasalahan</b>',['parse_mode' => 'HTML']);
...
Permasalahan : '.$this->Permasalahan);
    ...
    public function Cancel()
    {
        ...
        $this->say('<b>Proses Dibatalkan</b>. <pre>Jika berubah pikiran, Ketik </pre> /Helpdesk_Customer_Care_Center <i>- untuk mengajukan Permasalahan ke C3</i>', ['parse_mode' => 'HTML']);
    }
