...
class resetEmailDosen extends Conversation
{
    /**
     * First question
     */
    public function askReason()
    {
        ...
        return $this->ask($question, function (Answer $answer) {
            if ($answer->isInteractiveMessageReply()) {
                ...
                {
                    $this->say('Anda memilih :<b> Anda dapat mengakses Email</b>', ['parse_mode' => 'HTML']);
    ...
    {
        $this->ask('NIP/NIK Anda? Atau Email yang ingin direset', function(Answer $answer) {
...
Permasalahan : '.$this->Permasalahan);
        ...
        return $this->ask($question, function (Answer $answer){
            if ($answer->isInteractiveMessageReply()) {
                ...
                elseif ($answer->getValue() === 'netral') {
                    ...
                    $this->say('Atau Silahkan Datang ke Bagian C3 PTIPD UIN SUSKA RIAU');
                }
            }
        });
    }
    ...
    public function Cancel()
    {
        ...
        $this->say('<b>Proses Dibatalkan</b>. <pre>Jika berubah pikiran, Ketik </pre> /Reset_Gmail_PegawaiDosen <i>- untuk mengajukan Permasalahan Reset Password Gmail Pegawai atau Dosen</i>', ['parse_mode' => 'HTML']);
    }
